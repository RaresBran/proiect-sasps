...
class Settings(BaseSettings):
    ...
    # Application
    APP_NAME: str = Field(default="TaskTracker Monolithic API", description="Application name")
    ...
    DATABASE_URL: PostgresDsn = Field(
        default="postgresql://tasktracker:tasktracker@localhost:5432/tasktracker_db",
